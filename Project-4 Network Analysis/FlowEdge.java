...
public class FlowEdge 
{
    ...
    private String wireType;          // copper or optical
    private double cableLength;         // length of cable
    private double latency;          //speed of connection cablelength/capacity
     ...
     * @throws IllegalArgumentException if {@code capacity < 0.0}
     */
    public FlowEdge(int v, int w, double capacity,String wireType, double cableLength,double latency ) {
        if (v < 0) throw new IllegalArgumentException("vertex index must be a non-negative integer");
        if (w < 0) throw new IllegalArgumentException("vertex index must be a non-negative integer");
        if (!(capacity >= 0.0)) throw new IllegalArgumentException("Edge capacity must be non-negative");
        this.v         = v;
     ...
     * @return the Wire Type on the edge
     */
    public String wireType() {
        return wireType;
    }
     /**
     * Returns the cable length on the edge.
     * @return the cable length on the edge
     */
    public double cableLength() {
        return cableLength;
    }
    /**
     * Returns the latency on the edge.
     * @return the latency on the edge
     */
    ...
    public String toString() {
        return v+"->"+w+ " Capacity " + capacity +" Latency " + latency ;
    }
